		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 search">
				{{-- <div class="form-group">
					<input wire:model.debounce.250ms="search" name="s" value="" class="form-control" placeholder="Enter Keyword"
						type="text">
...
<div class="job-post pt-20 pb-30">
	<div class="container">
		<form enctype="multipart/form-data" method="POST" action="{{ route('edit.post.contact') }}" class="job-post-from">
		   @csrf
			<h2>Enregistrer votre Smart Contact</h2>
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input style="padding-left: 40px !important;font-size:16px !important; font-family:'Source Sans Pro', sans-serif !important; color:black !important;border:1px solid #aaa !important;"
								class="form-control" id="phone" type="tel" name="phone" required autocomplete="given-name" />
					</div>
				</div>
				...
				<div class="col-md-6">
					<div class="form-group">
						<label>Pays</label>
						<select name="country" class="js-example-basic-single" required id="countySel"
							style="width: 100%;">
				...
				<div class="col-md-6">
					<div class="form-group">
						<label>Sexe</label>
						<select name="sexe" class="js-example-basic-single" required
							style="width: 100%;">
							<option value="" style="color:#B2B2B2;">Selectionner votre sexe</option>
							<option value="Homme" style="color:#B2B2B2;">Homme</option>
							<option value="Femme" style="color:#B2B2B2;">Femme</option>
						</select>
					</div>
				</div>
				...
				<div class="col-md-6 profession1">
					<div class="form-group">
						...
						<select name="categorie1" id="slct1" onchange="populate(this.id,'slct2')" required class="js-example-basic-single" style="width: 100%;">
				...
				<div class="col-md-6 profession1">
					<div class="form-group">
						...
						<select name="secteur1" id="slct2" required class="js-example-basic-single" style="width: 100%;">
				...
				<div class="col-md- profession1">
					<div class="form-group">
						...
						<textarea required class="form-control description-area" id="exampleFormControlTextarea1"
							rows="6" name="desc1" placeholder="Description"></textarea>
					</div>
				</div>
				...
				<div class="col-md- profession3">
					<div class="form-group">
						...
						<textarea class="form-control description-area" id="exampleFormControlTextarea1" rows="6"
							name="desc3" placeholder="Description"></textarea>
					</div>
				</div>
